...
namespace ImGui
{
    ...
    IMGUI_API bool          MenuTabEx(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
...
//#endif
    ...
    bool BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, int* sizeX, int* sizeY);

    bool BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags, float* sizeX, float* sizeY);
