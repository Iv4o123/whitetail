...
bool e_elements::begin_child_ex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilled(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x, size.y), ImColor(255, 255, 255, 0), 4.0f);
    ...
    parent_window->DrawList->AddRectFilledMultiColorRounded(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x, size.y), ImColor(235, 235, 235), ImColor(235, 235, 235), ImColor(235, 235, 235), ImColor(235, 235, 235), ImColor(235, 235, 235), 5.0f, ImDrawCornerFlags_TopLeft);
    parent_window->DrawList->AddText(bold, 15.0f, parent_window->DC.CursorPos + ImVec2(16, 9), ImColor(24,24,24,90), name);
